...
1. Make an [Issue](https://github.com/softleitner/softleities/issues/new)
...
```json
    {
        "dependencies": {
            "com.softleitner.softleities": "https://github.com/YOUR_USER/softleities.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at softleitner@gmail.com.
